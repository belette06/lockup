class AddressController < ApplicationController
 ...
 # before_action :set_location, only: [:index, :new, :edit]
  ...
  def set_client
    @home = current_user.proprietor.homes.find_by(id: params[:home_id])
  end
  ...
  def appointment_params
    params.require(:appointment).permit(:home_id, :price, :location_id, location_attributes: [:nickname], client_attributes: [:name], appointment_time: [:date, :hour, :min], duration: [:hour, :min])
  end
